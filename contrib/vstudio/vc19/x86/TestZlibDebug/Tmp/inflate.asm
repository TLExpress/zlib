; Listing generated by Microsoft (R) Optimizing Compiler Version 19.26.28805.0 
	...
	TITLE	C:\Users\hank2\source\repos\zlib\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG95399 DB	'1.2.11', 00H
	ORG $+1
$SG95959 DB	'incorrect header check', 00H
	ORG $+1
$SG95961 DB	'unknown compression method', 00H
	ORG $+1
$SG95965 DB	'invalid window size', 00H
$SG95969 DB	'unknown compression method', 00H
	ORG $+1
$SG95971 DB	'unknown header flags set', 00H
	ORG $+3
$SG96018 DB	'header crc mismatch', 00H
$SG96035 DB	'invalid block type', 00H
	ORG $+1
$SG96039 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG96051 DB	'too many length or distance symbols', 00H
$SG96055 DB	'invalid code lengths set', 00H
	ORG $+3
$SG96065 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG96071 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG96074 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG96076 DB	'invalid literal/lengths set', 00H
$SG96078 DB	'invalid distances set', 00H
	ORG $+2
$SG96092 DB	'invalid literal/length code', 00H
$SG96103 DB	'invalid distance code', 00H
	ORG $+2
$SG96113 DB	'invalid distance too far back', 00H
	ORG $+2
$SG96126 DB	'incorrect data check', 00H
	ORG $+3
$SG96131 DB	'incorrect length check', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File C:\Users\hank2\source\repos\zlib\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 204  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG95399[edx]
	cmp	eax, ecx
...
; 681  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG95959
...
; 686  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG95961
...
; 695  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95965
...
; 710  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG95969
...
; 715  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95971
...
; 823  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96018
...
; 882  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96035
...
; 891  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96039
...
; 930  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96051
...
; 952  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96055
...
; 975  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96065
...
; 998  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96071
...
; 1012 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96074
...
; 1026 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96076
...
; 1035 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96078
...
; 1087 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96092
...
; 1123 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96103
...
; 1153 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96113
...
; 1212 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96126
...
; 1225 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96131
