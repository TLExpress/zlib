; Listing generated by Microsoft (R) Optimizing Compiler Version 19.25.28614.0 
	...
	TITLE	C:\Users\hank2\source\repos\ULU\ULU\zlib\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG95400 DB	'1.2.11', 00H
	ORG $+1
$SG95960 DB	'incorrect header check', 00H
	ORG $+1
$SG95962 DB	'unknown compression method', 00H
	ORG $+1
$SG95966 DB	'invalid window size', 00H
$SG95970 DB	'unknown compression method', 00H
	ORG $+1
$SG95972 DB	'unknown header flags set', 00H
	ORG $+3
$SG96019 DB	'header crc mismatch', 00H
$SG96036 DB	'invalid block type', 00H
	ORG $+1
$SG96040 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG96052 DB	'too many length or distance symbols', 00H
$SG96056 DB	'invalid code lengths set', 00H
	ORG $+3
$SG96066 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG96072 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG96075 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG96077 DB	'invalid literal/lengths set', 00H
$SG96079 DB	'invalid distances set', 00H
	ORG $+2
$SG96093 DB	'invalid literal/length code', 00H
$SG96104 DB	'invalid distance code', 00H
	ORG $+2
$SG96114 DB	'invalid distance too far back', 00H
	ORG $+2
$SG96127 DB	'incorrect data check', 00H
	ORG $+3
$SG96132 DB	'incorrect length check', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File C:\Users\hank2\source\repos\ULU\ULU\zlib\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 204  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG95400[edx]
	cmp	eax, ecx
...
; 681  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG95960
...
; 686  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG95962
...
; 695  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95966
...
; 710  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG95970
...
; 715  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG95972
...
; 823  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96019
...
; 882  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96036
...
; 891  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96040
...
; 930  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96052
...
; 952  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96056
...
; 975  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96066
...
; 998  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96072
...
; 1012 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG96075
...
; 1026 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96077
...
; 1035 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96079
...
; 1087 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96093
...
; 1123 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96104
...
; 1153 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG96114
...
; 1212 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96127
...
; 1225 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG96132
