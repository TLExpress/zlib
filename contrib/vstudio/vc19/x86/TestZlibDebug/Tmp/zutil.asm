; Listing generated by Microsoft (R) Optimizing Compiler Version 19.26.28805.0 
	...
	TITLE	C:\Users\hank2\source\repos\zlib\zutil.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG98855 DB	'need dictionary', 00H
$SG98856 DB	'stream end', 00H
	ORG $+1
$SG98858 DB	'file error', 00H
	ORG $+1
$SG98859 DB	'stream error', 00H
	ORG $+3
$SG98860 DB	'data error', 00H
	ORG $+1
$SG98861 DB	'insufficient memory', 00H
$SG98862 DB	'buffer error', 00H
	ORG $+3
$SG98863 DB	'incompatible version', 00H
_DATA	ENDS
...
_DATA	SEGMENT
	ORG $+3
$SG98866 DB	'1.2.11', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File C:\Users\hank2\source\repos\zlib\zutil.c
_TEXT	SEGMENT
_opaque$ = 8						; size = 4
_ptr$ = 12						; size = 4
_zcfree	PROC
