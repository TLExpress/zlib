; Listing generated by Microsoft (R) Optimizing Compiler Version 19.25.28614.0 
	...
	TITLE	C:\Users\hank2\source\repos\ULU\ULU\zlib\contrib\testzlib\testzlib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG98358 DB	'rb', 00H
	ORG $+5
$SG98419 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG98422 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG98423 DB	'file %s read, %u bytes', 0aH, 00H
$SG98427 DB	'1.2.11', 00H
	ORG $+1
$SG98428 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG98429 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG98430 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG98431 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG98432 DB	'1.2.11', 00H
	ORG $+1
$SG98433 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG98434 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG98435 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG98436 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG98439 DB	'compare ok', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File C:\Users\hank2\source\repos\ULU\ULU\zlib\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
...
; 1010 :     __asm    {
; 1011 :         mov     ecx, ShiftCount

	mov	ecx, DWORD PTR _ShiftCount$[ebp]

; 1012 :         mov     eax, dword ptr [Value]

	mov	eax, DWORD PTR _Value$[ebp]

; 1013 :         mov     edx, dword ptr [Value+4]

	mov	edx, DWORD PTR _Value$[ebp+4]

; 1014 :         shrd    eax, edx, cl
